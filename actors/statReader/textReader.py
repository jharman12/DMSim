...
class buildMonsterFromString:
    def __init__(self, text):
        ...
        print('Spell Mod: ', self.spellDC)
        print('Multiattack: ', self.multiattack)
        print('Leg Res: ', self.legRes)
        print('Leg Actions: ', self.legWeapons)
        
        self.monster = Monster(self.name, self.ac, self.health, self.speed, self.modDict, self.aWeapons, self.size, self.spells,
               self.spellDC, self.multiattack, self.legRes, self.legWeapons)
