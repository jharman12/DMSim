---
name: GUIHandler
description: This agent is in charge of handling the changes to the GUI itself. It will keep track of what works best and how everything is link together.
argument-hint: This agent expects tasks related to GUI modifications and optimizations.
